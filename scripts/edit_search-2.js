...
if ($('#rad_option2').hasClass("radSelected")) {
    ...
    dojo.connect(opsPointLayer, "onMouseOver", function(evt){
        var highlightSymbol = new esri.symbol.PictureMarkerSymbol("images/map/selected-2.jpg", 24, 24);
...
function initEditing(editLyr){
    ...
    var webSymbol = new esri.symbol.PictureMarkerSymbol("images/map/web-button-2.bmp", 20, 20);
    var photoSymbol = new esri.symbol.PictureMarkerSymbol("images/map/photo-button-2.bmp", 20, 20);
    var videoSymbol = new esri.symbol.PictureMarkerSymbol("images/map/video-button-2.bmp", 20, 20);
    var notesSymbol = new esri.symbol.PictureMarkerSymbol("images/map/notes-button-2.bmp", 20, 20);
